...
class DepthwiseSeparableConv(nn.Module):
    ...
    def __init__(
            ...
            se_layer=None,ema_layer=None, drop_path_rate=0.):
        ...
        self.ema = ema_layer(in_chs) if ema_layer and (in_chs > 320) else nn.Identity()
...
class InvertedResidual(nn.Module):
    ...
    def __init__(
            ...
            norm_layer=nn.BatchNorm2d, se_layer=None,ema_layer=None, conv_kwargs=None, drop_path_rate=0.):
        ...
        self.ema = ema_layer(mid_chs) if ema_layer and (mid_chs > 144) else nn.Identity()
