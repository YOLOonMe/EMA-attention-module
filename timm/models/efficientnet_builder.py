...
class EfficientNetBuilder:
    ...
    def __init__(self, output_stride=32, pad_type='', round_chs_fn=round_channels, se_from_exp=False,
                 act_layer=None, norm_layer=None, se_layer=None, ema_layer="ema", drop_path_rate=0., feature_location=''):
        ...
        self.ema_layer = get_attn(ema_layer)
        try:
            self.se_layer(8, rd_ratio=1.0)  # test if attn layer accepts rd_ratio arg
            # test if attn layer accepts rd_ratio arg
